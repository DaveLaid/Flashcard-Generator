...
var cq1a1 = new ClozeCard("In the original 'The Legend of Zelda' NES game, Ganon is the final boss.", "Ganon");
...
if (count < 10){
	console.log("Question: " + basicArray[count].front);
	inquirer.prompt([
      {
      	type: "input",
        name: "trivia",
...
// for testing....no longer needed due to user input of process.argv[2]
// askBasicQuestions();
...
if (count < 10){
	console.log("Question: " + clozeArray[count].partial);
...
// This user input will determine which game to start.  The "basic" Flashcards, or the "cloze" Flashcards.
if (roleArg === "basic") {
	askBasicQuestions();
}
if (roleArg === "cloze") {
	...
	console.log("Would you like to play 'NES Flash Cards?'  Please enter 'basic' or 'cloze' to initiate a game.");
}